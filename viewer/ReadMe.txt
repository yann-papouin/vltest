========================================================================
    ACTIVEX CONTROL DLL : GenViewer Project Overview
========================================================================

ControlWizard has created this project for your GenViewer ActiveX Control
...
that make up your GenViewer ActiveX Control DLL.
...
GenViewer.ico
    ...
    is included by the main resource file GenViewer.rc.

/////////////////////////////////////////////////////////////////////////////
CGenViewerCtrl control:

GenViewerCtrl.h
    This file contains the declaration of the CGenViewerCtrl C++ class.

GenViewerCtrl.cpp
    This file contains the implementation of the CGenViewerCtrl C++ class.

GenViewerPropPage.h
    This file contains the declaration of the CGenViewerPropPage C++ class.

GenViewerPropPage.cpp
    This file contains the implementation of the CGenViewerPropPage C++ class.

CGenViewerCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CGenViewerCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file GenViewer.rc.
...
stdafx.h, stdafx.cpp
    ...
    named GenViewer.pch and a precompiled types (PCT) file named stdafx.obj.
